...
async function processMessage(
  ...
  if (read_ct > MAX_RETRIES) {
    ...
    Sentry.captureException(new Error(`Raindrop import failed after ${MAX_RETRIES} retries`), {
    ...
    if (archiveError) {
      console.error(`[raindrop-worker] Archive failed for msg ${msg_id}:`, archiveError);
    ...
    console.log(`[raindrop-worker] Archived msg ${msg_id}: max_retries_exceeded`);

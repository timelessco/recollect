-- ============================================================================
-- Migration: match_similar_bookmarks RPC
-- ============================================================================
-- Purpose:
--   Rank bookmarks similar to a source bookmark using an additive score over
--   AI-extracted visual signals (OKLAB/OKLCh dominant colors, detected objects,
--   AI-inferred content types) plus user-curated tags/categories and url host
--   equality.
--
...
--         +  1 × shared_categories     -- bookmark_categories intersect
--         +  1 × same_domain           -- url host equality (www. stripped)
--

-- ============================================================================
-- MIGRATION: Add AI Embeddings Queue to Instagram RPC
-- Created: 2026-01-21
-- Purpose: Queue Instagram bookmarks for AI enrichment atomically
-- ============================================================================
--
-- This migration:
--   1. Updates process_instagram_bookmark RPC to queue to ai-embeddings
--   2. Enables AI enrichment (screenshot, captions, OCR) for Instagram bookmarks
--
-- ============================================================================
...
'Atomic Instagram bookmark processing with queue message deletion and AI enrichment queueing. Called by Edge Function worker.';

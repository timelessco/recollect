...
export function registerBookmarksMoveBookmarkToTrash() {
	registry.registerPath({
		...
		description:
			...
			"Set isTrash: true to trash, isTrash: false to restore. " +
			"Triggers revalidation for any affected public categories. " +
			"Returns the updated bookmark records with their new trash timestamps.",

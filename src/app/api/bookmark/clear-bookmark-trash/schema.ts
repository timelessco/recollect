...
export const ClearBookmarkTrashOutputSchema = z.object({
  deletedCount: z.number().meta({ description: "Total number of bookmarks permanently deleted" }),
  message: z.string().meta({ description: "Human-readable summary of the operation" }),
});

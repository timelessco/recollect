...
export const AddCategoryToBookmarkInputSchema = z.object({
  bookmark_id: z
...
export type AddCategoryToBookmarkInput = z.infer<typeof AddCategoryToBookmarkInputSchema>;

export const AddCategoryToBookmarkOutputSchema = z.array(
  z.object({
...
export type AddCategoryToBookmarkOutput = z.infer<typeof AddCategoryToBookmarkOutputSchema>;

...
export const AddCategoryToBookmarksInputSchema = z.object({
  bookmark_ids: z
    .array(
      z
  ...
  category_id: z
    ...
    .meta({
      description: "Category ID to assign (0 = uncategorized, positive = real category)",
    }),
});

export type AddCategoryToBookmarksInput = z.infer<typeof AddCategoryToBookmarksInputSchema>;

export const AddCategoryToBookmarksOutputSchema = z.array(
  z.object({
...
export type AddCategoryToBookmarksOutput = z.infer<typeof AddCategoryToBookmarksOutputSchema>;

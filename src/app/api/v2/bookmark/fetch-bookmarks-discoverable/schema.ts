...
export const V2FetchBookmarksDiscoverableInputSchema = z.object({
  page: z.coerce
    .number()
    .int()
    .nonnegative()
...
export const V2FetchBookmarksDiscoverableOutputSchema = z.array(DiscoverableBookmarkRowSchema);

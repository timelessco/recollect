...
export const FetchDiscoverableByIdInputSchema = z.object({
  id: z.coerce.number().int().positive().meta({ description: "Bookmark ID to fetch", example: 42 }),
});

export type FetchDiscoverableByIdInput = z.infer<typeof FetchDiscoverableByIdInputSchema>;
...
export const FetchDiscoverableByIdOutputSchema = z.object({
  addedCategories: z
    .array(CategorySchema)
    .meta({ description: "Categories assigned to this bookmark" }),
  addedTags: z.array(TagSchema).meta({ description: "Tags assigned to this bookmark" }),
...
export type FetchDiscoverableByIdOutput = z.infer<typeof FetchDiscoverableByIdOutputSchema>;

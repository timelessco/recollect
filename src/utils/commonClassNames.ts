...
export const grayInputClassName =
	"block w-[300px] bg-gray-alpha-100 appearance-none border-none text-sm leading-4 placeholder:text-sm placeholder:text-gray-600 text-gray-900 rounded-lg px-[10px] py-[7px] border-transparent focus:border-transparent focus:ring-0 placeholder:font-normal font-normal outline-hidden";

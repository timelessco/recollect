...
export const saveButtonClassName =
	"rounded-lg bg-gray-50 text-13 font-medium leading-[115%] text-gray-800 filter-[drop-shadow(0_0_1px_rgba(0,0,0,0.2))_drop-shadow(0_1px_1px_rgba(0,0,0,0.1))] hover:bg-gray-200";

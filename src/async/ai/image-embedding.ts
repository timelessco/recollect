 ...
 * instance regardless.
 *
 * SSRF: safeFetch (and its assertSafeImageUrl) reject non-https, RFC1918,
 * loopback, link-local, and IPv4-mapped private IPv6 before any byte leaves
 * the worker — including on each redirect's Location header.
 *

...
import { type BookmarksSortByTypes, type BookmarksViewTypes } from "./componentStoreTypes";
 ...
 */
export type ProfilesBookmarksViewOrLegacy = ProfilesBookmarksView | BookmarkViewDataTypes;
...
export type CategoriesData = {
  ...
  is_favorite?: boolean;
  is_public: boolean;
  user_id: Pick<ProfilesTableTypes, "id" | "email" | "profile_pic" | "user_name">;
};

  ...
  return (
    <>
      <div className="relative mb-[30px] flex items-center">
        ...
        <div className={`${settingsMainHeadingClassName} ml-[21px]`}>Change email</div>
      </div>
      <div className="border-b border-b-gray-200 pb-[28px]">
        <LabelledComponent label="Current email" labelClassName={settingsInputLabelClassName}>
      ...
      >
        ...
        <div className="mt-2 flex w-1/2 justify-start sm:mt-0 sm:justify-end">
          ...
          >
            {changeEmailLoader ? (
              <Spinner className="h-3 w-3 animate-spin" style={{ color: "var(--color-plain)" }} />
            ) : (
              "Change email"
            )}
          </Button>

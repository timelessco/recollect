			...
			<div className="flex h-[calc(100vh-95px)] items-center justify-center max-sm:mx-auto max-sm:w-full max-sm:max-w-md">
				<div className="w-[300px]">
					...
					<div className="space-y-4">
						...
						/>
						<button
							className="text-13 text-gray-0 shadow-custom-2 flex w-full cursor-pointer items-center justify-center rounded-lg bg-gray-950 py-[7px] text-center font-medium leading-[15px] hover:bg-gray-700"

				...
				<div className="flex h-[calc(100vh-95px)] items-center justify-center max-sm:mx-auto max-sm:w-full max-sm:max-w-md">
					<div className="w-[300px]">
						...
						<div className="flex flex-col items-center justify-center space-y-4">
							<button
								className="bg-gray-alpha-100 text-13 flex h-[30px] w-full justify-center rounded-lg py-[7.5px] font-medium leading-[15px] text-gray-950 hover:bg-gray-300"
							...
							<button
								className="text-13 text-gray-0 shadow-custom-2 flex w-full cursor-pointer items-center justify-center rounded-lg bg-gray-950 py-[7px] font-medium leading-[15px] hover:bg-gray-700"

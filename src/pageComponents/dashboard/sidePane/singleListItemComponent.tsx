...
const SingleListItemComponent = (listProps: listPropsTypes) => {
	...
	} ${extendedClassname} side-pane-anchor group flex cursor-pointer items-center justify-between rounded-lg px-2 outline-hidden focus-visible:ring-1 focus-visible:ring-gray-200 hover:bg-gray-100 hover:text-gray-900`;

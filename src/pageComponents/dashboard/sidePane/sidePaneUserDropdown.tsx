	...
	return (
		<div className="flex justify-between">
			<AriaDropdown
				menuButton={
					<div
						className={`${smoothHoverClassName} flex w-full items-center justify-between rounded-lg px-1 py-[3px]  hover:bg-surface-gray-2 hover:text-text-gray-8`}
					>
						<div className="flex w-4/5 items-center space-x-2">
							<UserAvatar
								alt="user-avatar"
								className="h-6 w-6 rounded-full bg-plain-reverse-color object-contain"
								height={24}
								src={
								...
								width={24}
							/>
							<p className="flex-1 overflow-hidden truncate text-left text-sm font-medium leading-4 text-text-gray-7">
				...
				menuButtonActiveClassName="!text-text-gray-8 bg-surface-gray-2 rounded-lg"

...
const PreviewModal = ({
	...
	const contentWidthClass =
		contentType === "url" ? "w-3/4 max-w-[1200px]" : "w-auto max-w-full";
	...
	return (
		<Drawer.Root onOpenChange={onOpenChange} open={isOpen}>
			<Drawer.Portal>
				...
				<Drawer.Content
					className={`fixed inset-x-0 bottom-0 z-[60] mx-auto h-[98%] ${contentWidthClass} rounded-t-3xl bg-black/50 outline-none backdrop-blur-sm`}
				>

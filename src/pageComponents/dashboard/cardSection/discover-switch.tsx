...
export const DiscoverSwitch = ({ bookmarkId, isDiscoverable }: DiscoverSwitchProps) => (
  <div className="flex items-center justify-between gap-3 px-2 py-[7.5px]">
    ...
    <div className="flex shrink-0 items-center">
      <DiscoverSwitchToggle bookmarkId={bookmarkId} isDiscoverable={isDiscoverable} />
    </div>
  </div>
);
...
function DiscoverSwitchToggle({ bookmarkId, isDiscoverable }: DiscoverSwitchToggleProps) {
  const { toggleDiscoverableOptimisticMutation } = useToggleDiscoverableOptimisticMutation();

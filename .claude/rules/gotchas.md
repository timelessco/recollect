...
- CHANGELOG.md is excluded from all linters/formatters (prettier, markdownlint, cspell) — formatting comes directly from Handlebars templates in `scripts/release-it/templates/`
